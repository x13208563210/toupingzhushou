...
const LABELS = {
  ...
  autoReplyRulesHint:
    '\u6bcf\u884c\u4e00\u6761\uff0c\u683c\u5f0f\uff1a\u5173\u952e\u8bcd=\u56de\u590d1|\u56de\u590d2\uff0c\u652f\u6301 *=\u901a\u7528\u56de\u590d\uff0c\u4e5f\u652f\u6301 {name}/{content} \u5360\u4f4d\u7b26\u3002\u5982\u679c\u540c\u65f6\u547d\u4e2d\u591a\u6761\uff0c\u4f1a\u4f18\u5148\u7528\u66f4\u5177\u4f53\u7684\u5173\u952e\u8bcd\u3002',
  autoReplyExactRulesHint:
    '\u6bcf\u884c\u4e00\u6761\uff0c\u683c\u5f0f\uff1a\u5b8c\u6574\u5f39\u5e55=\u56de\u590d1|\u56de\u590d2\u3002\u53ea\u6709\u6574\u53e5\u5b8c\u5168\u4e00\u6837\u65f6\u624d\u4f1a\u56de\u590d\uff0c\u4e5f\u652f\u6301 {name}/{content} \u5360\u4f4d\u7b26\u3002',
  autoReplyKeywordRulesHint:
    '\u6bcf\u884c\u4e00\u6761\uff0c\u683c\u5f0f\uff1a\u5173\u952e\u8bcd1|\u5173\u952e\u8bcd2=\u56de\u590d1|\u56de\u590d2\u3002\u4e00\u53e5\u8bdd\u91cc\u53ea\u8981\u5305\u542b\u5176\u4e2d\u4efb\u610f\u5173\u952e\u8bcd\u5c31\u4f1a\u89e6\u53d1\uff0c\u957f\u5173\u952e\u8bcd\u4f18\u5148\u3002',
  autoReplyFallbackHint:
    '\u6ca1\u6709\u547d\u4e2d\u89c4\u5219\u65f6\uff0c\u4ece\u8fd9\u91cc\u6309\u884c\u6216 | \u968f\u673a\u62bd\u53d6\u4e00\u6761\u56de\u590d\u3002',
...
const ABOUT_COPY = {
  ...
  features: [
    ...
    '\u81ea\u52a8\u56de\u590d\uff1a\u652f\u6301\u7cbe\u786e\u5339\u914d\u3001\u5173\u952e\u8bcd\u5339\u914d\u3001\u9ed8\u8ba4\u56de\u590d\u3001\u51b7\u5374\u65f6\u95f4\u3001\u53d1\u9001\u5ef6\u65f6\u548c\u91cd\u65b0\u8bb0\u5f55\u5750\u6807',
  ],
...
function parseAutoReplyReplyPoolSafe(text) {
  const replies = []
  splitAutoReplyLines(text).forEach((line) => {
    splitAutoReplyItemsSafe(line).forEach((item) => replies.push(item))
  })
  return replies
}
...
function parseAutoReplyRulesPreviewSafe(text) {
  ...
  splitAutoReplyLines(text).forEach((line) => {
    ...
    const label = line.slice(0, splitPos).trim()
    const replies = parseAutoReplyReplyPoolSafe(line.slice(splitPos + 1))
    if (!label || replies.length === 0) {
      invalidLines.push(line)
      return
    }
...
function buildAutoReplySummary(status) {
  return [
    {
      label: LABELS.autoReplyStatus,
      value: status?.autoReplyStatus || TEXT.waiting,
    },
    {
      label: LABELS.autoReplyTarget,
      value: status?.autoReplyTargetTitle || status?.danmakuUiProbeTargetTitle || '\u7b49\u5f85\u63a2\u6d4b',
    },
    {
...
function buildAutoReplyActions(status) {
  ...
  return [
    ...
    {
      action: 'toggleAutoReplySendEnabled',
      title: LABELS.autoReplySendToggle,
      detail: status?.autoReplySendEnabled
        ? `\u5f53\u524d\u4f1a\u771f\u6b63\u53d1\u9001\uff0c\u961f\u5217 ${status?.autoReplyPendingCount ?? 0} \u6761`
        : '\u5173\u95ed\u65f6\u53ea\u505a\u9884\u89c8\uff0c\u4e0d\u4f1a\u5f80\u76f4\u64ad\u4f34\u4fa3\u53d1\u9001',
      buttonText: status?.autoReplySendEnabled ? '\u5173\u95ed' : '\u5f00\u542f',
    },
    {
...
export default function App() {
  ...
  }, [status?.autoReplyCooldownSeconds, status?.autoReplyDelayMs, autoReplyTimingDirty])
  ...
  function saveAutoReplyTiming() {
    ...
    runAction('saveAutoReplyTiming', `${autoReplyCooldown}|${autoReplyDelay}`)
  }
      ...
      <main className="app-frame">
        ...
        <div className="frame-body">
          ...
          {page === 'auto-reply' && (
            ...
            <section className="info-row auto-reply-summary-row">
              {buildAutoReplySummary(status).map((item) => (
            ...
            <section className="action-grid auto-reply-action-grid">
              {buildAutoReplyActions(status).map((item, index) => {
                const isBusy = busyAction === item.action
                return (
                  <button
                    key={item.action}
                    ...
                    className={`action-card action-card-${(index % 4) + 1}`}
                    onClick={() => {
                      if (item.action === 'reloadAutoReplyConfig') {
        ...
        {page !== 'danmaku' && (
          <footer className="frame-footer">
            <div className="credit-tag">{TEXT.credit}</div>
