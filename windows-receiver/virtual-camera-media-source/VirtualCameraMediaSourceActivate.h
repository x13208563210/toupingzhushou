...
{
    struct __declspec(uuid("EEA24C6E-6EAD-4D1F-9D1A-CE0F21C91867"))
...
public:
    STDMETHODIMP CreateInstance(_In_ IUnknown*, _In_ REFIID riid, _COM_Outptr_ void** result) noexcept final try
    {
        ...
        *result = nullptr;
        ...
        winrt::com_ptr<winrt::WindowsSample::implementation::VirtualCameraMediaSourceActivate> ptr =
            winrt::make_self<winrt::WindowsSample::implementation::VirtualCameraMediaSourceActivate>();
